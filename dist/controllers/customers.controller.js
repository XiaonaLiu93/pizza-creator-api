...
let CustomersController = class CustomersController {
    ...
    async replaceById(id, customers) {
...
__decorate([
    rest_1.post('/customers', {
        responses: {
            '200': {
                ...
                content: { 'application/json': { schema: { 'x-ts-type': models_1.Customers } } },
            },
        },
    }),
    __param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Customers, { exclude: ['id'] }),
            },
        },
    })),
    ...
    rest_1.get('/customers', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: { type: 'array', items: { 'x-ts-type': models_1.Customers } },
                    },
                },
            },
        },
